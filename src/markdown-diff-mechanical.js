// Mechanical comparison engine. Product callers should import the verified compiler from
// markdown-diff.js, which proves both authoritative projections before releasing output.
...
export function compileMechanicalMarkdownDiff(baselineMarkdown, revisedMarkdown, options = {}) {
...
export function generateMechanicalCriticMarkup(baselineMarkdown, revisedMarkdown, options = {}) {
  return compileMechanicalMarkdownDiff(baselineMarkdown, revisedMarkdown, options).criticMarkup;
}
