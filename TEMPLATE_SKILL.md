...
4. `"reply_to_comment"`: Replies to an existing comment. The `bookmark_id` MUST be an `MKS_COMMENT_...` ID. Requires `"add_comment"`.

### JSON Schema per line
```json
{
  "bookmark_id": "MKS_PARA_00001", 
...
### Field Definitions
- **`bookmark_id`** (Required): The exact MKS ID provided in the prompt (e.g., `MKS_PARA_00042`, `MKS_CELL_1_2_3`, `MKS_FN_001`, or `MKS_COMMENT_3`).
...
### Example Output
```jsonl
{"bookmark_id": "MKS_PARA_00012", "change_type": "replace_text", "new_text": "The project will conclude in Q3.", "add_comment": "Removed passive voice.", "apply_change": true, "confidence": "High"}
{"bookmark_id": "MKS_PARA_00015", "change_type": "delete_element", "apply_change": true, "confidence": "Medium"}
{"bookmark_id": "MKS_COMMENT_2", "change_type": "reply_to_comment", "add_comment": "I agree, we should verify these numbers with finance.", "apply_change": true, "confidence": "High"}
```
